...
class Analyzer():
    ...
    def analyze(self, tools, classifier_test_results, out_file):
        ...
        # self.plot_loss_vs_batches(out_file['loss_classifier_train_batch'].value, out_file['loss_classifier_test_batch'].value, folder+"/loss_batches.eps")
        # self.plot_accuracy_vs_batches(out_file['accuracy_classifier_train_batch'].value, out_file['accuracy_classifier_test_batch'].value, folder+"/accuracy_batches.eps")
        # self.plot_loss_vs_epoch(out_file['loss_classifier_train_epoch'].value, out_file['loss_classifier_test_epoch'].value, folder+"/loss_epoch_batches.eps")
        # self.plot_accuracy_vs_epoch(out_file['accuracy_classifier_train_epoch'].value, out_file['accuracy_classifier_test_epoch'].value, folder+"/accuracy_epoch_batches.eps")
        self.plot_loss_vs_batches(out_file['class_reg_loss_train_batch'].value, out_file['class_reg_loss_test_batch'].value, folder+"/loss_batches.eps")
        self.plot_accuracy_vs_batches(out_file['class_acc_train_batch'].value, out_file['class_acc_test_batch'].value, folder+"/accuracy_batches.eps")
        self.plot_loss_vs_epoch(out_file['class_reg_loss_train_epoch'].value, out_file['class_reg_loss_test_epoch'].value, folder+"/loss_epoch_batches.eps")
        self.plot_accuracy_vs_epoch(out_file['class_acc_train_epoch'].value, out_file['class_acc_test_epoch'].value, folder+"/accuracy_epoch_batches.eps")
        self.plot_ROC(classifier_test_scores, classifier_test_truth, folder+"/ROC.eps")
