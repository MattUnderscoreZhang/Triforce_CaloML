...
basePath = "/u/sciteam/zhang10/Projects/DNNCalorimeter/Data/NewSamples/Variable/"
...
options['nEpochs'] = 3 # break after this number of epochs
...
options['nfiltECAL'] = int(sys.argv[6])
options['kernelxyECAL'] = int(sys.argv[7])
options['kernelzECAL'] = options['kernelxyECAL']
options['nfiltHCAL'] = 3
