...
oldFilePath = "../AllFiles/H5Files/v1/Unskimmed_withOpeningAngle/"
newFilePath = "../AllFiles/H5Files/v1/Skimmed_withOpeningAngle/"
...
for fileName in filesToSkim:
    ...
    badIndices = [index for index, ratio in enumerate(oldFile['ECAL_HCAL_Ratios/HCAL_ECAL_ERatio']) if ratio > 0.2 or not np.isfinite(ratio)]
    ...
    if len(badIndices) < len(oldFile['ECAL_HCAL_Ratios/HCAL_ECAL_ERatio']):
