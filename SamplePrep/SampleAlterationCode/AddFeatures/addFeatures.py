...
def convertFile(inFile, outFile):
    ...
    for i in range(6):
        ...
        if i == 0:
            ECAL_midX = ECAL_momentX.transpose()
    ...
    for i in range(6):
        ...
        if i == 0:
            ECAL_midY = ECAL_momentY.transpose()
    ...
    for i in range(6):
        ...
        if i == 0:
            ECAL_midZ = ECAL_momentZ.transpose()
    ...
    if has_HCAL:
        ...
        for i in range(6):
            ...
            if i == 0:
                HCAL_midX = HCAL_momentX.transpose()
        ...
        for i in range(6):
            ...
            if i == 0:
                HCAL_midY = HCAL_momentY.transpose()
        ...
        for i in range(6):
            ...
            if i == 0:
                HCAL_midZ = HCAL_momentZ.transpose()
